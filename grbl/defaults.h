...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_LASER_MOD
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM 80.2
  #define DEFAULT_Y_STEPS_PER_MM 80.2
  #define DEFAULT_Z_STEPS_PER_MM 250.0
...
#ifdef DEFAULTS_LASERPEN_MOD
  // Settings for modified Grbl Laser and Pen plotter
  #define DEFAULT_X_STEPS_PER_MM 80.2
  #define DEFAULT_Y_STEPS_PER_MM 80.2
  #define DEFAULT_Z_STEPS_PER_MM 250.0
  #define DEFAULT_X_MAX_RATE 2000.0 // mm/min
  ...
  #define DEFAULT_HOMING_DEBOUNCE_DELAY 250 // msec (0-65k)
  #define DEFAULT_HOMING_PULLOFF 1.0 // mm
  // Use PenMode when Laser_Mode is set to 0
  // Be Careful : Laser and Pen share digital pin 11 change tool before change Mode 
  #define PEN_SERVO
  #define PEN_SERVO_DOWN     24   // Adjust servo position at low    
  #define PEN_SERVO_UP       20   // Adjust servo position at top
  #define PENSERVO_TCCRA_INIT_MASK (1<<COM2A1) | ((1<<WGM20) | (1<<WGM21))
  #define PENSERVO_TCCRB_INIT_MASK (1<<CS22) | (1 <<CS21) | (1<<CS20)
#endif
